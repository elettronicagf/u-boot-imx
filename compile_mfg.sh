VERSION=$(cat Makefile | grep EXTRAV | grep 0659 | awk -F"-" '{print $2"-"$3}')
...
make distclean
make egf_sbc_mx6ull_mfg_wid0659_aa0101_config
make -j8
cp u-boot-dtb.imx binaries/u-boot.imx.wid0659aa0101-$VERSION
