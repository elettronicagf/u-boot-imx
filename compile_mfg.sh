...
make CROSS_COMPILE=arm-egf-linux-gnueabi- egf_evb_mx6_mfg_wid0500ad0101_config
make CROSS_COMPILE=arm-egf-linux-gnueabi- -j8
mv u-boot.imx binaries/u-boot.imx.wid0500ad0101-$VERSION
make CROSS_COMPILE=arm-egf-linux-gnueabi- egf_evb_mx6_mfg_wid0500ae0101_config
make CROSS_COMPILE=arm-egf-linux-gnueabi- -j8
