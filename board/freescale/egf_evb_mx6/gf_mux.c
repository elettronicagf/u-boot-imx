...
static iomux_v3_cfg_t const gpio_pads[] = {
	...
	//various
	IOMUX_PADS(PAD_GPIO_4__GPIO1_IO04		| NO_PAD_CTRL_SION_CFG), // Wifi CD (PGF0533_A01) or GPIO (PGF0533_A02 + PGF0533_A03) */
	IOMUX_PADS(PAD_GPIO_2__GPIO1_IO02		| NO_PAD_CTRL_SION_CFG), // Wifi WP (PGF0533_A01) or RTC_CLKOE (PGF0533_A02 + PGF0533_A03)*/
...
void wifi_TiWi_mux(void)
{
	// BT+BLE
	SETUP_IOMUX_PAD(PAD_CSI0_VSYNC__GPIO5_IO21 	| DIO_PAD_PDOWN_CFG); // WMD_PWR_EN_3V3 - GPIO 149
	SETUP_IOMUX_PAD(PAD_EIM_A16__GPIO2_IO22		| DIO_PAD_PDOWN_CFG); // WLAN_EN_3V3    - GPIO 54
	SETUP_IOMUX_PAD(PAD_EIM_A17__GPIO2_IO21		| DIO_PAD_PDOWN_CFG); // BT_EN_3V3      - GPIO 53
	SETUP_IOMUX_PAD(PAD_CSI0_DAT12__GPIO5_IO30	| DIO_PAD_CFG);       // WLAN_IRQ_3V3   - GPIO 158
}

void wifi_ATWIL3000_mux(void)
{
	SETUP_IOMUX_PAD(PAD_CSI0_VSYNC__GPIO5_IO21 	| DIO_PAD_PDOWN_CFG); // WMD_RESETN _3V3 - GPIO 149
	SETUP_IOMUX_PAD(PAD_EIM_A16__GPIO2_IO22		| DIO_PAD_PDOWN_CFG); // WMD_CHIP_EN_3V3 - GPIO 54
	SETUP_IOMUX_PAD(PAD_CSI0_DAT12__GPIO5_IO30	| DIO_PAD_CFG);       // WLAN_IRQ_3V3    - GPIO 158
}
