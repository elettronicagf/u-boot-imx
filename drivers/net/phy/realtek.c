...
#define PHY_RTL8211x_FORCE_MASTER 1 << 1
#define PHY_RTL8211E_PINE64_GIGABIT_FIX 1 << 2
#define PHY_RTL8211F_FORCE_EEE_RXC_ON 1 << 3
#define PHY_RTL8201F_S700_RMII_TIMINGS 1 << 4
...
static int rtl8211f_config(struct phy_device *phydev)
{
	...
	phy_write(phydev, MDIO_DEVAD_NONE, 0x10, 0x207f);
	phy_write(phydev, MDIO_DEVAD_NONE,
		  MIIM_RTL8211F_PAGE_SELECT, 0x0);
